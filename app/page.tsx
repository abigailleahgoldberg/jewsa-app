    ...
    <>
      ...
      <section id="calendar" style={{padding:"80px max(24px,5vw)",background:"var(--navy)"}}>
        <div style={{maxWidth:1100,margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:56}}>
            ...
            <p style={{fontSize:15,color:"rgba(245,240,232,0.45)",maxWidth:580,margin:"0 auto",lineHeight:1.7}}>Jewish life runs on a lunisolar calendar older than most nations. These are the days that anchor it — observed by Jewish communities worldwide. Gregorian dates shift each year as the two calendars realign.</p>
          </div>
          {/* Legend */}
          ...
          <div style={{display:"flex",gap:16,justifyContent:"center",marginTop:32,flexWrap:"wrap"}}>
            <Link href="/calendar" style={{background:"var(--gold)",color:"var(--navy)",fontWeight:900,fontSize:13,letterSpacing:"1.5px",textTransform:"uppercase",padding:"14px 28px",textDecoration:"none"}}>View Full Calendar</Link>
            <Link href="/gifts" style={{background:"transparent",color:"var(--white)",fontWeight:900,fontSize:13,letterSpacing:"1.5px",textTransform:"uppercase",padding:"12px 24px",border:"2px solid rgba(245,240,232,0.25)",textDecoration:"none"}}>Gift Guides</Link>
            <Link href="/holidays" style={{background:"transparent",color:"var(--white)",fontWeight:900,fontSize:13,letterSpacing:"1.5px",textTransform:"uppercase",padding:"12px 24px",border:"2px solid rgba(245,240,232,0.25)",textDecoration:"none"}}>All Holidays</Link>
          </div>
        </div>
      </section>
      ...
      <footer className="jewsa-footer" style={{background:"#04101F",borderTop:"1px solid rgba(201,168,76,0.15)",padding:"36px max(24px,5vw)",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16}}>
        ...
        <div className="jewsa-footer-links" style={{display:"flex",gap:20,flexWrap:"wrap"}}>
          {[["Shop","#shop"],["Holidays","/holidays"],["Gifts","/gifts"],["Culture","/culture"],["Daily Verse","/daily-verse"],["Calendar","/calendar"]].map(([l,h])=>(
