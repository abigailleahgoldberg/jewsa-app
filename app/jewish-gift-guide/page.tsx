  ...
  return (
    <div style={{minHeight:"100vh",background:"#F0F4FF",color:"#0D0D0D",fontFamily:"system-ui,sans-serif"}}>
      <nav style={{padding:"16px 5vw",borderBottom:"1px solid #DBEAFE",display:"flex",justifyContent:"space-between",alignItems:"center",background:"white"}}>
        ...
        <Link href="/blog" style={{color:"#666",textDecoration:"none",fontSize:14}}>Back to Blog</Link>
      </nav>
      <div style={{maxWidth:800,margin:"0 auto",padding:"60px 5vw"}}>
        ...
        <div style={{display:"grid",gap:16,marginBottom:40}}>
          {categories.map((c,i) => (
            <div key={i} style={{background:"white",border:"1px solid #DBEAFE",borderRadius:8,padding:"20px"}}>
        ...
        <div style={{marginTop:40}}>
          <Link href="/blog" style={{color:G,fontWeight:700,textDecoration:"none"}}>Back to Blog</Link>
        </div>
      </div>
    </div>
  );
