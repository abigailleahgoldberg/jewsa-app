...
export const metadata: Metadata = {
  title: 'Privacy Policy | JEWSA',
  description: 'Privacy Policy for JEWSA. Learn how we collect, use, and protect your personal information.',
};
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'rgba(10,22,40,0.05)', border: '1px solid #e8e0d0', borderRadius: '8px', padding: '2rem', marginBottom: '2rem' }}>
          <p style={{ lineHeight: 1.8 }}>
            JEWSA (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) operates https://jewsa.com. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
          </p>
        </div>
