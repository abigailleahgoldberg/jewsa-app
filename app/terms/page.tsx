...
export const metadata: Metadata = {
  title: 'Terms of Service | JEWSA',
  description: 'Terms of Service for JEWSA. Please read these terms carefully before using our website.',
};
  ...
  return (
    <main style={{ background: '#FAF7F0', color: '#0A1628', minHeight: '100vh', padding: '2rem 1rem' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#0A1628', opacity: 0.6, marginBottom: '2rem', fontSize: '0.9rem' }}>
          Last updated: March 2026
        </p>

        <div style={{ background: 'rgba(10,22,40,0.05)', border: '1px solid #e8e0d0', borderRadius: '8px', padding: '2rem', marginBottom: '2rem' }}>
          <p style={{ lineHeight: 1.8 }}>
            Please read these Terms of Service carefully before using https://jewsa.com operated by The Voice of Cash (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). By accessing or using our service, you agree to be bound by these terms.
          </p>
        </div>

        <section style={{ marginBottom: '2rem' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 600, color: '#C9A84C', marginBottom: '1rem', paddingBottom: '0.5rem', borderBottom: '1px solid #e8e0d0' }}>
            1. Acceptance of Terms
          </h2>
          <p style={{ lineHeight: 1.8 }}>
            By accessing and using https://jewsa.com, you accept and agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use our website.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ lineHeight: 1.8 }}>
            JEWSA provides online content, information, and services through our website. We reserve the right to modify, suspend, or discontinue any aspect of the service at any time without notice.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ lineHeight: 1.8 }}>
            All content on https://jewsa.com, including but not limited to text, graphics, logos, images, audio clips, and software, is the property of The Voice of Cash / JEWSA and is protected by United States and international copyright laws. You may not reproduce, distribute, or create derivative works without our express written permission.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ lineHeight: 1.8 }}>
            To the fullest extent permitted by law, The Voice of Cash and JEWSA shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of, or inability to use, this website or its content. Our total liability shall not exceed the amount paid by you, if any, for accessing our services.
          </p>
        </section>
